...
export default function NavLink({links, main, dropDown}) {
  ...
  const toggleMenu = () => setDropActivate(!isDropActive);
      ...
      {dropDown && (
        <>
          <button
            ...
            aria-expanded={isDropActive} //Whether the dropdown is currently visible 
          ...
          <ul 
            ...
            role='menu'
            aria-hidden={!isDropActive} //Only visible when isDropActive is true
          >
            {/* Menu items */}
            {links.map((ele, idx) => (
