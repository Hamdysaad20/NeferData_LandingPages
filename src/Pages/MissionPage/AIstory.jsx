...
function AIstory() {
    ...
    const products = [
        ...
        },
        {
          ...
          description: 'AI powers your search for perfect SaaS tools, helping you make informed business choices.',
        ...
        },
        {
            title: (
                ...
                >
                  ...
                  <span className="text-white px-4 py-[6px] relative   text-sm bg-gray-700/40 animate-pulse grid place-items-center w-20 rounded-full ">soon
    ...
    <Sparkels />
          ...
          description: ' Never miss a deadline. AI tracks & optimizes your SaaS agreements. Easy automation, boosted compliance. ',
          icon: <MdProductionQuantityLimits />,
          data: (
            <div className="bg-white p-4 rounded shadow h-full">
              <p className="text-lg font-bold mb-2">Product Name</p>
...
Embrace The AI Advantage
            ...
            Neferdata is your <span className='underline decoration-4	decoration-wavy decoration-clone decoration-sky-400 underline-offset-[6px]'> trusted partner on Artificial Intelligence </span> adoption journey to help you achieve your business goals. We provide AI-powered tools tailored for you to help you succeed.
            </p>{" "}
          </div>
        </div>
      </header>
