    ...
    <div
      ...
      <div className='w-full justify-center pb-12 pt-6 flex'>
        <div
          ...
          <span>Neferdata: <span className='underline decoration-sky-500'>AI tools </span>for  <span className='underline decoration-sky-500'>business growth</span> .</span>
      ...
      <section className='flex flex-col max-w-[1500px] w-[90%]  items-center justify-center m-auto gap-2 mb-48'>
          ...
          {tabs.map((tab, index) => (
            <button
              ...
              <div className='h-12   w-full  flex justify-center gap-2 px-4 items-center  rounded-2xl border-2 border-black text-black'>
                <tab.Icon />
                <div className='leading-[16px] font-medium text-[0.875rem] text-black'>{tab.title}</div>
        ...
        <div className='flex flex-col h-[700px] bg-[#3092DB] backdrop-blur-2xl w-full rounded-2xl p-4 divide-white/20 divide-y-2'>
