...
const PrimaryButton = ({ title, onClick, classes }) => (
  <button
    ...
    className={`select-none active:scale-95 duration-300 rounded-full py-2 px-5 text-center text-lg font-bold bg-blue-1 transition-all hover:bg-blue-500 capitalize text-white ${classes}`}>
    {title}
  </button>
);
