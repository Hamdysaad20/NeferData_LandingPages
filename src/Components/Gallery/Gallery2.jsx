...
export default function Gallery2() {
  ...
  return (
    <section className="w-[90%] max-md:w-full max-w-[1200px] flex justify-center flex-col items-center mx-auto py-32 px-16 max-lg:px-8 max-md:px-6 gap-12  box-border">
      ...
      <div className="h-[400px] relative sm:h-[700px] bg-[#3092DB] text-black  overflow-hidden rounded-2xl p-2 py-12 pt-32 w-full max-w-[1400px] flex justify-center items-center gap-12  box-border">
        <div className='absolute top-0 flex justify-center flex-col text-center  pt-4 left-0  w-full'>
<div
 className='flex justify-center items-center gap-4'>
<p className={`${statistics.color} font-bold  text-lg max-w-[90%]  md:text-4xl`}>
            {statistics.text}
          </p>
</div>
