...
const renderLinks = (links) =>
  links.map((link, idx) => (
    <li key={idx} className=' z-10 '>
      <a
        href={link.url}
        className='text-white h-full w-full duration-500 hover:text-gray-900 
...
function Footer() {
  ...
  const LINKS = [
    ...
    },
    {
      title: "Helpful Links",
      links: [
        { url: "/contact", title: "Contact" ,status:true },
        { url: "/help", title: "FAQs" ,status:false},
        { url: "/pricing", title: "Pricing" ,status:true },
        { url: "/blog", title: "Blog" ,status:false },
    ...
    },
    {
      title: "Legal",
      links: [
        { url: "/", title: "Accessibility",status:false},
        { url: "/privacy-policy", title: "Privacy Policy",status:true  },
        { url: "/", title: "Security Policy",status:false},
        { url: "/", title: "Hiring Statistics",status:false},
      ],
    },
  ];
    ...
    <footer className='bg-[#3092DB] rounded-t-[30px] overflow-hidden w-full relative'>
      ...
      <div className='mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8'>
        <div className='grid grid-cols-1 relative w-full gap-8 lg:grid-cols-3'>
          <div className='relative w-full  z-10'>
            <div className='text-white w-auto '>
              <div className='flex items-center -mt-4 w-auto'>
                <Link
                  ...
                  <img
                    src={logoImg}
                    alt='Neferdata Company Logo'
                    className='aspect-square w-8'
                  />
                  <span className='font-bold select-none text-2xl '>
                    Neferdata
                  </span>
                </Link>
              </div>
            ...
            <p className='mt-4 max-w-xs font-bold text-white'>
              Better way to get value from your SaaS investments by making the
              right choices.
            </p>

            <p className='mt-4 max-w-xs text-white font-bold '>
              <span className='relative'>Contact:</span> <br />
            </p>
        ...
        <p className='text-xs font-bold text-gray-50'>
          © {CurrentYear}.Neferdata. All rights reserved.
        </p>
      </div>
    </footer>
  );
